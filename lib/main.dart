...
import 'package:digital_projucti/features/auth/presentation/pages/signup_page.dart';
...
void main() {
  runApp(const DigitalProjukti());
}

class DigitalProjukti extends StatefulWidget {
  const DigitalProjukti({super.key});

  @override
  State<DigitalProjukti> createState() => _DigitalProjuktiState();
}

class _DigitalProjuktiState extends State<DigitalProjukti> {
  int selectedIndex = 0;
